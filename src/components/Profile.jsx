        ...
        <div className="text-white bg-navy-blue rounded-xl mt-6 flex">
           ...
           <div className="mt-6 480:mt-10 -ml-20 text-xs 480:text-base lg:ml-0 lg:mt-3">
            ...
            <div className="flex flex-col 480:-ml-12 md:flex-row md:justify-between lg:ml-0">
                ...
                <p className="ml-5">{prop.profile.location != null ? prop.profile.location : "Not Available"}</p>
                </div>
                <div className="flex items-center mb-4">
                   ...
                   {prop.profile.blog != "" ? <a href = {prop.profile.blog}  target = "_blank" rel = "noreferrer"className = "ml-4 hover:underline active:underline">{prop.profile.blog}</a> : <p className="ml-4">Not Available</p>}
                   </div>
                   </div>
                <div className="flex flex-col md:mt-8 md:mr-20">
                    ...
                    {prop.profile.twitter_username != null ? <a href = {`https://twitter.com/${prop.profile.twitter_username}`}  target = "_blank" rel = "noreferrer"className = "ml-4 hover:underline active:underline">{prop.profile.twitter_username}</a> : <p className="ml-4">Not Available</p>}
                    </div>
                    ...
                    <p className="ml-4">{prop.profile.company != null ? prop.profile.company : "Not Available"}</p>
                    </div>
                </div>
            </div>
            </div>
